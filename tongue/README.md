...
`tongue/datasets/` so the layout looks like the table below.

| Item                | Location                                                                |
|---------------------|-------------------------------------------------------------------------|
| Dataset (download)  | <https://datadryad.org/dataset/doi:10.5061/dryad.1c59zw48r>             |
| Dataset (local)     | `tongue/datasets/shezhenv3-coco`                               |
| YOLO YAML           | `tongue/coco/shezhenv3_coco_dataset.yaml`                      |
| Label → profile map | `tongue/coco/tongue_label_profiles.json`                       |
...
```
tongue/runs/train-2/weights/best.pt
```
...
`tongue/predict_result_from_bytes.py` exposes a function suitable
...
```
tongue/runs/shezhenv3_coco/predict_result.json
```
...
`tongue/datasets/`，按下表组织好目录结构。

| 项目             | 路径                                                                 |
|------------------|----------------------------------------------------------------------|
| 数据集下载       | <https://datadryad.org/dataset/doi:10.5061/dryad.1c59zw48r>          |
| 数据集放置位置   | `tongue/datasets/shezhenv3-coco`                            |
| YOLO YAML        | `tongue/coco/shezhenv3_coco_dataset.yaml`                   |
...
`tongue/predict_result_from_bytes.py` 提供一个可直接被其他
